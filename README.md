<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2196F3&center=true&vCenter=true&width=435&lines=M2+AI+Student+%40+Sorbonne+Universit%C3%A9;Looking+for+Internship+(Feb+2026);Apocalypse+Survival+Strategist;Data+Science+%26+ML+Engineer" alt="Typing SVG" />
</div>

# Hi there, I'm Abdelrahman! 👋

I’m currently navigating the **Master 2 in Machine Learning & AI (MIND)** at **Sorbonne Université**. 

I like digging into data to find answers to the important questions in life, like **"Where should I hide during an apocalypse?"** (Yes, I actually built a pipeline for that).
...
**Languages:** Python , SQL, Java, C, JavaScript (React/Node).

**The Data Stack:** PyTorch, Scikit-learn, Pandas, Spark, Docker, Ansible.

**Human Languages:** 🇺🇸 English (Fluent) · 🇫🇷 French (Fluent) · 🇪🇬 Arabic (Native) · 🇪🇸 Spanish (Beginner).

---

### ⚡ Lightning Round
* **Leadership:** I served as President of the SGMI Association, managing a team of 25+ people (I promise I didn't let the power go to my head).
* **Advocacy:** I was a Student Representative at Sorbonne, bridging the gap between students and faculty.
* **Current Quest:** I am actively looking for a **Master's Internship** in Data Science / AI starting **February 2026**.

---

### 📫 Let's Connect
If you want to talk about Machine Learning, compare notes on surviving global catastrophes, or offer me an internship:

* **LinkedIn:** [Abdelrahman Elguindy](https://linkedin.com/in/AbdelrahmanElguindy)
* **Email:** [bidoelguindy@gmail.com](mailto:bidoelguindy@gmail.com)
